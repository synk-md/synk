...
export const PasteIcon = React.memo(
  ({ className, width = 24, height = 24, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
      <svg
        viewBox="0 0 24 24"
        width={width}
