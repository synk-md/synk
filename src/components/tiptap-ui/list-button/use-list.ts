...
export function useList(config: UseListConfig) {
  ...
  useHotkeys(
    ...
    },
    {
      ...
      // BulletList/OrderedList/TaskList already register this same shortcut
      // as a native ProseMirror keymap; firing it again while the editor is
      // focused would double-toggle.
