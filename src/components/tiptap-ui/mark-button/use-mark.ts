...
export function useMark(config: UseMarkConfig) {
  ...
  useHotkeys(
    ...
    },
    {
      ...
      // The mark extensions (Bold, Italic, ...) already register this same
      // shortcut as a native ProseMirror keymap. Firing it again here while
      // the editor itself is focused would toggle the mark twice (once via
      // ProseMirror, once via this global listener) and cancel itself out.
